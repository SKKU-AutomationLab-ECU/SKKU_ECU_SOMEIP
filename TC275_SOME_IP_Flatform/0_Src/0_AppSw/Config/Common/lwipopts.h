...
//
#define NO_SYS            1        /**< \brief single thread (without os-awareness) */
...
#define MEM_SIZE            (10 * 1024)      /**< \brief default is only 1600 */
...
// PBUF options
//
#define PBUF_POOL_SIZE      16              /**< \brief default is 16 */ //세정이 16으로 바꿈 원래 8
...
// RAW options
//
#define LWIP_RAW           1	  			/**< \brief Enable application layer to hook into the IP layer itself */
//#define RAW_TTL                 (IP_DEFAULT_TTL)

//________________________________________________________________________________________
// DHCP options
//
#define LWIP_DHCP          0	  			/**< \brief Enable DHCP module */
...
#define CHECKSUM_CHECK_UDP 1                /**< \brief default is 1 */
#define CHECKSUM_GEN_UDP   1                /**< \brief default is 1 */

//________________________________________________________________________________________
// TCP options
//
#define LWIP_TCP           1                /**< \brief default is 1 */
#define TCP_TTL                 IP_DEFAULT_TTL         /**< \brief default is (IP_DEFAULT_TTL) */
...
//________________________________________________________________________________________
// Netconn options - Enable Netconn API (require to use api_lib.c)
//
#define LWIP_NETCONN      0                 /**< \brief default is 1 */

//________________________________________________________________________________________
// Socket options - Enable Socket API (require to use sockets.c)
//
...
// Ethernet options
//
#define ETH_PAD_SIZE      0                 /**< \brief default is 0 */
...
//#define UDP_DEBUG                       LWIP_DBG_OFF     /**< \brief default is OFF */
...
#define PING_DEBUG              LWIP_DBG_OFF             /**<\brief default is OFF */

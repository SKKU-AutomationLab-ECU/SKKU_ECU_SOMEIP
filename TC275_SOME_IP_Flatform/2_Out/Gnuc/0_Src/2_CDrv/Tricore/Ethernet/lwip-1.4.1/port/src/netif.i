# 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
# 1 "D:\\00.Workspace\\TC275\\SKKU_ECU_SOMEIP\\TC275_SOME_IP_Flatform//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
# 48 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
...
# 49 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 51 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 52 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 53 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 54 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 55 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
# 1 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/netif/etharp.h" 1
# 44 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/netif/etharp.h"
...
# 45 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/netif/etharp.h" 2
...
err_t ip_output_if(struct pbuf *p, ip_addr_t *src, const ip_addr_t *dest,
       u8_t ttl, u8_t tos, u8_t proto,
       struct netif *netif);
# 46 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/netif/etharp.h" 2
...
# 56 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
# 1 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/netif/ppp_oe.h" 1
# 57 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 59 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 60 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 62 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 63 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 64 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2

# 1 "./0_Src/4_McHal/Tricore/Eth/Std/IfxEth.h" 1
# 66 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
...
# 70 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c" 2
# 81 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
struct ethernetif
{
    eth_addr_t *ethaddr;
...
const IfxEth_RmiiPins rmii_pins = {&IfxEth_CRSDVA_P11_11_IN,
...
# 106 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
static void low_level_init(netif_t *netif)
{
...

    {
        ...
        EthConfig.miiPins = ((void *)0);




        EthConfig.ethSfr = &((*(Ifx_ETH *)0xF001D000u));
        EthConfig.rxDescr = &IfxEth_rxDescr;
        EthConfig.txDescr = &IfxEth_txDescr;
        IfxEth_init(ethernetif, &EthConfig);
# 165 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
    }
}
# 184 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
static err_t low_level_output(netif_t *netif, pbuf_t *p)
{
    ...
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("low_level_output (p=%#x)\n", p); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    ...
    else
    {
        ...
        for (q = p; q != ((void *)0); q = q->next)
        {
            ...
            l = l + q->len;
            do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("low_level_output: data=%#x, %d\n", q->payload, q->len); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
            do { if(!((l < 1536))) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "low_level_output: length overflow the buffer\n", 216, "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"); ; } while(0);
        }

        IfxEth_sendTransmitBuffer(ethernetif, l);
    }

    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("low_level_output: signal length: %d\n", length); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    ...
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("low_level_output: return OK\n"); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    return 0;
}
# 245 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
static pbuf_t *low_level_input(netif_t *netif)
{
    ...
    if (p != ((void *)0))
    {
        ...
        for (q = p; q != ((void *)0); q = q->next)
        {
# 291 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
            memcpy(q->payload, src, q->len);

            src = &src[q->len];

            do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("low_level_input: payload=0x%x, len=%d\n", q->payload, q->len); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
...
# 330 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
...
# 371 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/netif.c"
  ...
  default:
   ...
   do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("ifx_netif_input: type unknown\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
   pbuf_free(p);
   p = ((void *)0);
   break;
    }

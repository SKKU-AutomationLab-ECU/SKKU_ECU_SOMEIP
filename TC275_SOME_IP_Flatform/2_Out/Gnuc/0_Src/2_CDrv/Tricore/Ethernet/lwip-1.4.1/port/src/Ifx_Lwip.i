# 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
# 1 "D:\\00.Workspace\\TC275\\SKKU_ECU_SOMEIP\\TC275_SOME_IP_Flatform//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
# 27 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
...
# 28 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 29 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 30 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 31 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2

# 1 "./0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/include/Ifx_Netif.h" 1



err_t ifx_netif_init(struct netif *netif);
err_t ifx_netif_input(struct netif *netif);
# 33 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 34 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 35 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
extern boolean IfxStm_initCompare(Ifx_STM *stm, IfxStm_CompareConfig *config);
...
# 57 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
...
# 76 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean areInterruptsEnabled(void)
{
    return IfxCpu_areInterruptsEnabled();
}
# 89 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean disableInterrupts(void)
{
...
# 123 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) void restoreInterrupts(boolean enabled)
{
    IfxCpu_restoreInterrupts(enabled);
}
# 149 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
extern Ifx_TickTime TimeConst[(11)];
# 158 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
...
# 202 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime now(void)
{
    Ifx_TickTime stmNow;
...
# 221 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime nowWithoutCriticalSection(void)
{
    Ifx_TickTime stmNow;
...
# 238 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime addTTime(Ifx_TickTime a, Ifx_TickTime b)
{
    Ifx_TickTime result;
...
# 261 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime elapsed(Ifx_TickTime since)
{
    return now() - since;
}
# 273 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime getDeadLine(Ifx_TickTime timeout)
{
...
# 296 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime getTimeout(Ifx_TickTime deadline)
{
...
# 320 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean isDeadLine(Ifx_TickTime deadLine)
{
    boolean result;
...
# 345 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean poll(volatile boolean *test, Ifx_TickTime timeout)
{
...
# 26 "./0_Src/0_AppSw/Tricore/Device_Driver/Driver_System/SysCFG_Cores.h" 2
# 57 "./0_Src/0_AppSw/Tricore/Device_Driver/Driver_System/SysCFG_Cores.h"
...
# 36 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 38 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
...
# 62 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.h"
...
# 12 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_ETH.h"
...
# 14 "./0_Src/0_AppSw/Tricore/System/Service_Handler/Event_Trigger.h"
extern void ISR_UART_Rx_SysCom(char *buffer);
void convert_serial(void);
extern void ISR_SCUERU_SWinput(void);
extern void ISR_EtherNet_Rx(int len, unsigned char *buffer);
...
# 39 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2
# 73 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
#pragma section ".bss_cpu0" awc0
# 108 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
Ifx_Lwip g_Lwip;
IfxEth g_IfxEth;
uint32 isrTxCount=0;
uint32 isrRxCount=0;
uint8 channel0TxBuffer1[4][(2560+14 +2)];
uint8 channel0RxBuffer1[4][(2560+14 +2)];


#pragma section
# 126 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
extern App_Cpu0 g_AppCpu0;
# 150 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
void Ifx_Lwip_onTimerTick(void)
{
    Ifx_Lwip *lwip = &g_Lwip;
    uint16 timerFlags = lwip->timerFlags;

    { lwip->timer.arp += 1; if (lwip->timer.arp >= (5000 / (1U))) { lwip->timer.arp = 0; timerFlags |= (1U << 1); } };

    { lwip->timer.tcp_fast += 1; if (lwip->timer.tcp_fast >= (0.1 / (1U))) { lwip->timer.tcp_fast = 0; timerFlags |= (1U << 2); } };
    { lwip->timer.tcp_slow += 1; if (lwip->timer.tcp_slow >= ((2*0.1) / (1U))) { lwip->timer.tcp_slow = 0; timerFlags |= (1U << 3); } };
    ...
    { lwip->timer.link += 1; if (lwip->timer.link >= (100U / (1U))) { lwip->timer.link = 0; timerFlags |= (1U << 4); } };
...
# 202 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
    if (timerFlags & (1U << 2))
    {
        tcp_fasttmr();
    }
...
# 250 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
void Ifx_Lwip_init(eth_addr_t ethAddr)
{
    ip_addr_t default_ipaddr, default_netmask, default_gw;
    (&default_gw)->addr = ((u32_t)((99) & 0xff) << 24) | ((u32_t)((0) & 0xff) << 16) | ((u32_t)((168) & 0xff) << 8) | (u32_t)((192) & 0xff);
    (&default_ipaddr)->addr = ((u32_t)((111) & 0xff) << 24) | ((u32_t)((0) & 0xff) << 16) | ((u32_t)((168) & 0xff) << 8) | (u32_t)((192) & 0xff);
    (&default_netmask)->addr = ((u32_t)((0) & 0xff) << 24) | ((u32_t)((255) & 0xff) << 16) | ((u32_t)((255) & 0xff) << 8) | (u32_t)((255) & 0xff);

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("Ifx_Lwip_init start!\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
# 285 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("Ifx_Lwip_init end!\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
}
...
# 304 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
void ISR_Eth(void);
void ISR_Eth(void)
{
    ...
    if (IfxEth_isTxInterrupt(eth) != 0)
    {
        IfxEth_clearTxInterrupt(eth);
        eth->isrTxCount++;
    }

    if (IfxEth_isRxInterrupt(eth) != 0)
    {
...
# 333 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c" 2

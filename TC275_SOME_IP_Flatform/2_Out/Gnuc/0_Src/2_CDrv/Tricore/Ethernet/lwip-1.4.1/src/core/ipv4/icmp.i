# 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
# 1 "D:\\00.Workspace\\TC275\\SKKU_ECU_SOMEIP\\TC275_SOME_IP_Flatform//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
# 42 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
...
# 43 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2



# 1 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/ipv4/lwip/icmp.h" 1
# 36 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/ipv4/lwip/icmp.h"
...
# 37 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/ipv4/lwip/icmp.h" 2
...
# 38 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/ipv4/lwip/icmp.h" 2
...
# 39 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/ipv4/lwip/icmp.h" 2
...
# 47 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 48 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
err_t ip_output_if(struct pbuf *p, ip_addr_t *src, const ip_addr_t *dest,
       u8_t ttl, u8_t tos, u8_t proto,
       struct netif *netif);
# 49 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 51 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 52 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 54 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c" 2
# 65 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 76 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
void
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (pbuf_header(p, -hlen) || (p->tot_len < sizeof(u16_t)*2)) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: short ICMP (%""u"" bytes) received\n", p->tot_len); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    goto lenerr;
  }
  ...
  case 8:

    {
      ...
      if (!accepted) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: Not echoing to multicast or broadcast pings\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ++lwip_stats.icmp.err;
        pbuf_free(p);
        return;
      }
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: ping\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    if (p->tot_len < sizeof(struct icmp_echo_hdr)) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: bad ICMP echo received\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto lenerr;
    }
    if (inet_chksum_pbuf(p) != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: checksum failed for received ICMP echo\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      pbuf_free(p);
    ...
    if (pbuf_header(p, (20 + 16))) {
      ...
      if (pbuf_header(p, hlen)) {
        do { if(!(0)) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: moving p->payload to ip header failed\n", 152, "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"); ; } while(0);
        goto memerr;
      }

      r = pbuf_alloc(PBUF_LINK, p->tot_len, PBUF_RAM);
      if (r == ((void *)0)) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: allocating new pbuf failed\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        goto memerr;
      }
      do { if(!((r->len >= hlen + sizeof(struct icmp_echo_hdr)))) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct the ICMP header",
 162
# 161 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
      ,
 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
# 161 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
      ); ; } while(0)
                                                                  ;

      if (pbuf_copy(r, p) != 0) {
        do { if(!(0)) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: copying to new pbuf failed\n", 165, "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"); ; } while(0);
        goto memerr;
      }
      iphdr = (struct ip_hdr *)r->payload;

      if (pbuf_header(r, -hlen)) {
        do { if(!(0)) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: restoring original p->payload failed\n", 171, "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"); ; } while(0);
        goto memerr;
      }
      ...
      if (pbuf_header(p, -(s16_t)(20 + 16))) {
        do { if(!(0)) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: restoring original p->payload failed\n", 181, "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"); ; } while(0);
        goto memerr;
      }
    }
    ...
    if(pbuf_header(p, hlen)) {
      do { if(!(0)) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "Can't move over header in packet", 218, "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"); ; } while(0);
    } else {
      err_t ret;
      ...
      ret = ip_output_if(p, (&current_iphdr_dest), ((void *)0),
                   (255), 0, 1, inp);
      if (ret != 0) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: ip_output_if returned an error: %c.\n", ret); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    break;
  default:
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_input: ICMP type %""d"" code %""d"" not supported.\n", (s16_t)type, (s16_t)code); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                          ;
...
# 260 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
void
icmp_dest_unreach(struct pbuf *p, enum icmp_dur_type t)
{
  icmp_send_response(p, 3, t);
}
# 274 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
void
icmp_time_exceeded(struct pbuf *p, enum icmp_te_type t)
{
  icmp_send_response(p, 11, t);
}
# 290 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == ((void *)0)) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_time_exceeded: failed to allocate pbuf for ICMP packet.\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return;
  }
  do { if(!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) Ifx_Lwip_printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold icmp message",
 307
# 306 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
  ,
 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
# 306 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/src/core/ipv4/icmp.c"
  ); ; } while(0)
  ...
  iphdr = (struct ip_hdr *)p->payload;
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("icmp_time_exceeded from "); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("%""u"".%""u"".%""u"".%""u", &(iphdr->src) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->src)))[0])) : 0, &(iphdr->src) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->src)))[1])) : 0, &(iphdr->src) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->src)))[2])) : 0, &(iphdr->src) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->src)))[3])) : 0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf (" to "); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { Ifx_Lwip_printf ("%""u"".%""u"".%""u"".%""u", &(iphdr->dest) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->dest)))[0])) : 0, &(iphdr->dest) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->dest)))[1])) : 0, &(iphdr->dest) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->dest)))[2])) : 0, &(iphdr->dest) != ((void *)0) ? ((u16_t)(((u8_t*)(&(iphdr->dest)))[3])) : 0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

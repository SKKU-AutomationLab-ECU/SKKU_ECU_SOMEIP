...
.Ltext0:
	...
	.type	Ifx_Lwip_onTimerTick, @function
Ifx_Lwip_onTimerTick:
.LFB536:
	.file 1 "0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
	.loc 1 151 0
.LVL0:
	.loc 1 153 0
	movh.a	%a15, hi:g_Lwip
	lea	%a15, [%a15] lo:g_Lwip
	.loc 1 155 0
	ld.h	%d2, [%a15] 54
	.loc 1 153 0
	ld.hu	%d15, [%a15] 62
...
.LVL11:
	...
	j	.L5
.LFE536:
	.size	Ifx_Lwip_onTimerTick, .-Ifx_Lwip_onTimerTick
	.align 1
	.global	Ifx_Lwip_pollTimerFlags
	.type	Ifx_Lwip_pollTimerFlags, @function
...
.LBB37:
.LBB38:
	.file 4 "./0_Src/4_McHal/Tricore/Eth/Std/IfxEth.h"
	.loc 4 1076 0
	ld.a	%a2, [%a2] 48
	calli	%a2
.LVL20:
...
.LVL23:
.LFE537:
	.size	Ifx_Lwip_pollTimerFlags, .-Ifx_Lwip_pollTimerFlags
	.align 1
	.global	Ifx_Lwip_pollReceiveFlags
	.type	Ifx_Lwip_pollReceiveFlags, @function
...
.LVL24:
.LFE538:
	.size	Ifx_Lwip_pollReceiveFlags, .-Ifx_Lwip_pollReceiveFlags
	.align 1
	.global	Ifx_Lwip_init
	.type	Ifx_Lwip_init, @function
Ifx_Lwip_init:
.LFB539:
	.loc 1 251 0
	.loc 1 253 0
...
.LVL25:
	...
	lea	%a5, [%SP] 28
	st.w	[%SP]0, %d15
	movh	%d15, hi:ifx_netif_init
	addi	%d15, %d15, lo:ifx_netif_init
	lea	%a6, [%SP] 32
	lea	%a7, [%SP] 36
	st.w	[%SP] 4, %d15
	movh	%d15, hi:ethernet_input
	addi	%d15, %d15, lo:ethernet_input
	st.w	[%SP] 8, %d15
	call	netif_add
.LVL26:
	.loc 1 266 0
...
.LVL28:
.LFE539:
	.size	Ifx_Lwip_init, .-Ifx_Lwip_init
	.align 1
	.global	sys_now
...
.LBB42:
	...
	movh.a	%a2, 61442
	lea	%a2, [%a2] -12288
	movh.a	%a15, hi:g_IfxEth
	ld.w	%d15, [%a2] 8212
	lea	%a15, [%a15] lo:g_IfxEth
	ld.w	%d2, [%a15] 20
.LVL30:
.LBE42:
.LBE41:
...
.LVL39:
	...
	ret
.LFE542:
	.size	Ifx_Lwip_printf, .-Ifx_Lwip_printf
	.global	channel0RxBuffer1
.section .bss_cpu0,"awc0",@progbits
	.type	channel0RxBuffer1, @object
	.size	channel0RxBuffer1, 10304
channel0RxBuffer1:
	.zero	10304
	.global	channel0TxBuffer1
	.type	channel0TxBuffer1, @object
	.size	channel0TxBuffer1, 10304
channel0TxBuffer1:
	.zero	10304
	.global	isrRxCount
	.align 2
	.type	isrRxCount, @object
	.size	isrRxCount, 4
isrRxCount:
	.zero	4
	.global	isrTxCount
	.align 2
	.type	isrTxCount, @object
	.size	isrTxCount, 4
isrTxCount:
	.zero	4
	.global	g_IfxEth
	.align 2
	.type	g_IfxEth, @object
	.size	g_IfxEth, 104
g_IfxEth:
	.zero	104
	.global	g_Lwip
...
.Letext0:
	...
	.file 9 "./0_Src/4_McHal/Tricore/_Reg/IfxEth_regdef.h"
	.file 10 "./0_Src/4_McHal/Tricore/_Reg/IfxPort_regdef.h"
	.file 11 "./0_Src/4_McHal/Tricore/Port/Std/IfxPort.h"
	.file 12 "./0_Src/4_McHal/Tricore/_PinMap/IfxEth_PinMap.h"
	.file 13 "./0_Src/4_McHal/Tricore/_Impl/IfxSrc_cfg.h"
	.file 14 "./0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/include/arch/cc.h"
	.file 15 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/lwip/err.h"
	.file 16 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/lwip/pbuf.h"
	.file 17 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/ipv4/lwip/ip_addr.h"
	.file 18 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/lwip/netif.h"
	.file 19 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/netif/etharp.h"
	.file 20 "./0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/include/Ifx_Lwip.h"
	.file 21 "./0_Src/0_AppSw/Tricore/Main/CpuX_Main.h"
	.file 22 "./0_Src/0_AppSw/Config/Common/stdarg.h"
	.file 23 "./0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.h"
	.file 24 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/lwip/tcp_impl.h"
	.file 25 "./0_Src/2_CDrv/TriCore/ETHERNET/LWIP-1.4.1/src/include/lwip/init.h"
	.file 26 "./0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/include/Ifx_Netif.h"
	.file 27 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\stdio.h"
	.file 28 "./0_Src/0_AppSw/Tricore/System/Systems/SysCFG_Log.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/2_CDrv/Tricore/Ethernet/lwip-1.4.1/port/src/Ifx_Lwip.c"
	...
	.byte	0x5
	.byte	0x3
	.uaword	channel0TxBuffer1
	.uleb128 0x4d
	.string	"channel0RxBuffer1"
	.byte	0x1
	.byte	0x71
	.uaword	0xe37e
	.byte	0x1
...
.LASF19:
	...
	.extern	netif_set_up,STT_FUNC,0
	.extern	netif_set_default,STT_FUNC,0
	.extern	netif_add,STT_FUNC,0
	.extern	ethernet_input,STT_FUNC,0
	.extern	ifx_netif_init,STT_FUNC,0
	.extern	lwip_init,STT_FUNC,0
	.extern	ifx_netif_input,STT_FUNC,0
	.extern	netif_set_link_down,STT_FUNC,0
	.extern	etharp_tmr,STT_FUNC,0
	.extern	netif_set_link_up,STT_FUNC,0
	.extern	tcp_fasttmr,STT_FUNC,0
	.extern	tcp_slowtmr,STT_FUNC,0

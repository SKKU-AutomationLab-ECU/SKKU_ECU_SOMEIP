...
# 12 "./0_Src/0_AppSw/Tricore/System/Service_Handler/Timed_Trigger.h"
...
# 88 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_System/SysCFG_Cores.c"
}
...
void Enable_STM_Task00(void)
{
 ...
 stm00->CMP[0].U = IfxStm_getOffsetTimer(stm00, 0) + (TimeConst[(8)]);
...
void Enable_STM_Task01(void)
{
 ...
 stm01->CMP[1].U = IfxStm_getOffsetTimer(stm01, 0) + (TimeConst[(7)]);
...
void Enable_STM_Task10(void)
{
 ...
 stm10->CMP[0].U = IfxStm_getOffsetTimer(stm10, 0) + (TimeConst[(7)]);
...
void Enable_STM_Task11(void)
{
 ...
 stm11->CMP[1].U = IfxStm_getOffsetTimer(stm11, 0) + (TimeConst[(7)]);
...
void Enable_STM_Task20(void)
{
 ...
 stm20->ISCR.B.CMP0IRR = 1U;
    ...
    stm20->CMP[0].U = IfxStm_getOffsetTimer(stm20, 0) + (TimeConst[(7)]);
...
void Enable_STM_Task21(void)
{
 ...
 stm21->CMP[1].U = IfxStm_getOffsetTimer(stm21, 0) + (TimeConst[(7)]);
...
void ISR_STM_Task00(void)
{
 ...
 stm00 = &((*(Ifx_STM *)0xF0000000u));
 stm00->ISCR.B.CMP0IRR = 1U;
 stm00->CMP[0].B.CMPVAL = stm00->TIM0.U + (TimeConst[(8)]);
...
void ISR_STM_Task01(void)
{
 ...
 stm01 = &((*(Ifx_STM *)0xF0000000u));
 stm01->ISCR.B.CMP1IRR = 1U;
 stm01->CMP[1].B.CMPVAL = stm01->TIM0.U + (TimeConst[(7)]);
...
void ISR_STM_Task10(void)
{
 ...
 stm10 = &((*(Ifx_STM *)0xF0000100u));
 stm10->ISCR.B.CMP0IRR = 1U;
 stm10->CMP[0].B.CMPVAL = stm10->TIM0.U + (TimeConst[(7)]);
...
void ISR_STM_Task11(void)
{
 ...
 stm11 = &((*(Ifx_STM *)0xF0000100u));
 stm11->ISCR.B.CMP1IRR = 1U;
 stm11->CMP[1].B.CMPVAL = stm11->TIM0.U + (TimeConst[(7)]);
...
void ISR_STM_Task20(void)
{
 ...
 stm20 = &((*(Ifx_STM *)0xF0000200u));
 stm20->ISCR.B.CMP0IRR = 1U;
 stm20->CMP[0].B.CMPVAL = stm20->TIM0.U + (TimeConst[(7)]);
...
void ISR_STM_Task21(void)
{
 ...
 stm21 = &((*(Ifx_STM *)0xF0000200u));
 stm21->ISCR.B.CMP1IRR = 1U;
 stm21->CMP[1].B.CMPVAL = stm21->TIM0.U + (TimeConst[(7)]);

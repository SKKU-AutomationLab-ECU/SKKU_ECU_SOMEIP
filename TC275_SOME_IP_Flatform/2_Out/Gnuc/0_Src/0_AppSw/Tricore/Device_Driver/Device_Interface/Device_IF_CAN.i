...
# 9 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.c" 2
...
void IO_set_CAN(void)
{
 ...
 IO_set_CAN_BitRate(0, 500000, 2000000);
 IO_set_CAN_BitTiming(0, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_BitRate(1, 500000, 2000000);
 IO_set_CAN_BitTiming(1, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_BitRate(2, 500000, 2000000);
 IO_set_CAN_BitTiming(2, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_BitRate(3, 500000, 2000000);

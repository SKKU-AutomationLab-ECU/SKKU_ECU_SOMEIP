...
static Ifx_P * const pGPIO_LCD_chip_select = (Ifx_P *)&((*(Ifx_P *)0xF003C000u));
...
void config_chip_select_IO(void)
{
 pGPIO_LCD_chip_select->IOCR0.B.PC3 = 0b10000;
}
...
void f_chip_select(int bit) {pGPIO_LCD_chip_select->OUT.B.P3 = bit;}
# 685 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_GPIO.c"
void setPort_GPIO_dxl(void) {}
int setBit_GPIO_dxl(uint8 number) {}
# 700 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_GPIO.c"
__inline void Delay_ms_GPIO(unsigned int tic_ms)
{
